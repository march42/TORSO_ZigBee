 ...
 *
 * @details	Used for different (mostly identical) LED light controller based on ZT3L module.
 * 			Designed for march42 TORSO light.
 * 
 * 			This header also describes the variations of Tuya TS050xB LED light controller.
 * 
 ...
 * 
 * 
 * @version 1.0.release8	2025-02-14
 * 
