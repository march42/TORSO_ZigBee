/********************************************************************************************************
 * @file	board_8258_ts050xb.h
 *
 * @brief	This is the header file for Tuya TS050xB module (with ZT3L)
 * 
 * @details	This header describes the variations of Tuya TS050xB LED light controller.
 * 			This controllers are based on Tuya ZT3L module
 * 
 * 			TS0501B LED dimming light
 * 
 * 			TS0502B	LED CCT cold/warm light
 * 
 * 			TS0503B	LED RGB light
 * 
 * 			TS0504B	LED RGBW light
 * 
 * 			TS0505B	LED RGB-CCT light
 * 
 *
 * @version 1.0.release8	2025-02-10
 * 
 ...
 * 4	D7	n.c. IR_IN (? DEBUG_INFO_TX_PIN)
 * 5	D2	(PWM) LED_B
 * 6	C3	(PWM) LED_G
 * 7	C2	(PWM) LED_WW
...
//	buttons
#define BUTTON1						GPIO_PC0	// pairing, FAC_RST button on board
